...
/*
 * Function to search for a string in another string. For usage examples
 * read the unity tests or the documentation.
 ...
 * given parameters. For usage examples read the unity tests or the
 * documentation.
